...
###TODO create loading for test images --- there is missing segmentation.nii.gz




#!!!carefull test images can have different number of slices in one human-body scan!!!
#!!!test !!!
#num of images : 611 -> 0...610
...
def load_data(data_path,num_of_file):
        ...
        @param : num_of_file - serial number of file --- in our case 0 - 209"""
        # example load
