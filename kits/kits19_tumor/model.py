...
# best approaches for winning https://www.kaggle.com/c/data-science-bowl-2018/discussion/54741
# EASY MODEL https://github.com/zhixuhao/unet/blob/master/model.py
# ADVANCED MODEL https://github.com/ellisdg/3DUnetCNN/ advanced loss functions
...
def Unet2D_small(input_size,use_softmax, num_classes,regularizer = None):
    ...
    num_classes = num_classes #background,kidney,tumor
    #in 128x128x3
